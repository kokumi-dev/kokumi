...
// DefaultDestination returns the OCI destination URL used when no explicit
// destination has been configured. It follows the pattern
// oci://<DefaultRegistryHost>/<namespace>/<name>.
